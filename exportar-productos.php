                            ...
                            <div class="card-body">
                                <form id="formProductos" method="post" onSubmit="return false;">
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-auto">
                                            <a href="export-data.php?entityName=productos" class="btn btn-primary">Export to excel</a>                                                    
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-striped table-bordered table-responsive" id="tbProductos">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $addRowsToSession = false;
                                                if(!isset($_REQUEST['productosRows']) ){
                                                    $_SESSION['productosRows'] = array(); // guardo la coleccion en session por si hay que exportar
                                                    $addRowsToSession = true;
                                                }
                                            
                                                foreach ($productos as $row) {

                                                    if ($addRowsToSession == True) {
                                                     $_SESSION['productosRows'][] = $row; // guardo los registros en session
                                                    }
