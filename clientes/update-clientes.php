<?php
require_once('../bff/clientes/update-clientes-view-model.php');
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $input_solo_contacto = trim($_POST["soloContacto"]);

    actualizarCliente($id, $input_apellido, $input_nombre, $input_dni, $input_email, $input_descuento, $input_solo_contacto);
    ...
    if(isset($_GET["id"]) && !empty(trim($_GET["id"]))){
        ...
        $clienteEditarViewModel = obtenerClienteParaEditarViewModel($id);
        $val = $clienteEditarViewModel['cliente'];
        ...
        $soloContacto = $val["solo_contacto"];
                        ...
                        <div class="card-body">
                            <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                        foreach ($clienteEditarViewModel['descuentos'] as $val) {
                                        ?>
