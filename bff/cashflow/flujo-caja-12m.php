...
require_once dirname(__DIR__, 2) . '/app/CashFlow/Infrastructure/LegacyCashFlowReadRepository.php';

use App\CashFlow\Infrastructure\LegacyCashFlowReadRepository;
...
try {
    $repositorio = new LegacyCashFlowReadRepository();
    $flujo = $repositorio->obtenerFlujo12Meses();
