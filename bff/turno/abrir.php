...
if ($rol !== 0) {
    JsonResponse::enviar(array('error' => array('codigo' => 'SOLO_ADMINISTRADOR')), 403);
}
...
try {
    $turno = TurnosBootstrap::abrirTurno()->ejecutar(
        $canalId,
    ...
    JsonResponse::enviar(array('data' => array('turno' => $turno)), 201);
