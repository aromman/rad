...
require_once dirname(__DIR__, 2) . '/app/Presupuesto/Infrastructure/LegacyPresupuestoReadRepository.php';

use App\Http\JsonResponse;
use App\Presupuesto\Infrastructure\LegacyPresupuestoReadRepository;
...
try {
    $repositorio = new LegacyPresupuestoReadRepository();
