...
require_once "../bff/informes/compras-canales-mensual-view-model.php";

$comprasCanalesMensualViewModel = obtenerComprasCanalesMensualViewModel();
$comprasCanalesMensualListado = $comprasCanalesMensualViewModel['resumen'];
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Compras Canales</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered" id="tbConsignaciones">
                                    ...
                                    <tbody>
                                        <?php
                                            if (count($comprasCanalesMensualListado) > 0) {
                                                ...
                                                foreach ($comprasCanalesMensualListado as $row) {
                                                    $colAno = $row['ano'];
                                        ...
                                        ?>
                                                <tr class="bg-info">
                                                    ...
                                                    <td align="right"><b><?php echo $totalCantidadMes; ?></b></td>
