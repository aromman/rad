...
<html lang="en">
        ...
        <script>
            $(document).ready(function(e) {
                                ...
                                '<div class="card mb-4 rounded-3 shadow-sm h-100" style="border: 1px solid ' + color + ';' + (esActiva ? '' : ' opacity: 0.6;') + '">' +
                                    ...
                                    '<div class="card-body text-center">' +
                                        ...
                                        '<div class="d-flex justify-content-center gap-3">' +
                                            ...
                                            '<a href="view-cuenta.php?forwardOk=cuentas-personales.php&id=' + escapeHtml(row.id) + '" class="text-primary" title="Ver"><i class="fa fa-fw fa-eye fa-lg"></i></a>' +
                ...
                var cargarCuentas = function() {
                    ...
                    var url = '../bff/cuentas/control.php?ambitoUso=PERSONAL' + (incluirInactivas ? '&incluirInactivas=1' : '');
                ...
                $('#cuentasCards').on('click', '.js-borrar-cuenta', function(e) {
                    ...
                    $.getJSON('../bff/cuentas/verificar-baja.php?id=' + encodeURIComponent(id))
                        .done(function(response) {
                            ...
                            $form.append($('<input>').attr({ type: 'hidden', name: 'forwardOk', value: 'cuentas-personales.php' }));
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Cuentas Personales</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item">Finanzas</li>
                            <li class="breadcrumb-item">Cuentas</li>
                            <li class="breadcrumb-item active">Cuentas Personales</li>
                        </ol>
        ...
        <?php include_once 'nuevoModalPersonal.php'; ?>
