...
$userRole = isset($_SESSION['user.rol']) ? (int) $_SESSION['user.rol'] : -1;

// Permite que Nginx entregue la navegación antes de completar la consulta.
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                foreach ($productos as $row) {
                                                    ...
                                                    $colPrecio = ($colStock > 0 ) ? '$ ' . number_format($row['precio'], 0, ".", "") : '';
                                            ...
                                            <tr class="<?php echo $className; ?>">
                                                ...
                                                <td align="center">
                                                    <a href="view-productos.php?forwardOk=productos.php&id=<?php echo $row['id'];?>" class="text-primary"><i class="fa fa-fw fa-eye"></i></a>
                                                    <?php if ($userRole === 0) { ?>
                                                    <a href="update-productos.php?id=<?php echo $row['id'];?>" class="text-primary"><i class="fa fa-fw fa-pencil"></i></a>
                                                    <a href="clone-productos.php?id=<?php echo $row['id'];?>" class="text-primary"><i class="fa fa-fw fa-copy"></i></a>
                                                    <a href="../delete-entity.php?entityName=productos&forwardOk=productos/productos.php&delId=<?php echo $row['id'];?>" class="text-danger" onClick="return confirm('Esta seguro de querer borrar este producto?');"><i class="fa fa-fw fa-trash"></i></a>
                                                    <?php } ?>
                                                </td>                            
                                            </tr>
